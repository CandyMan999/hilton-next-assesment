...
function (_Component) {
  ...
  function Reservation(props) {
    ...
    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(Reservation).call(this, props));
    ...
    var _results = Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_13__["getResults"])(); //if it does exsist we will spread in the results up to the index of the largest room selected and add the default values of the remaining rooms back to state


    if (_results !== null) {
      var remainingRooms = _this.state.rooms.slice(Number(_results.largestRoom), 3);

      _this.setState({
        largestRoom: _results.largestRoom,
        rooms: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_results.rooms), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(remainingRooms))
      });
    }
...
//# sourceMappingURL=index.js.20ef336109fb903ac1ab.hot-update.js.map